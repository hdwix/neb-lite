...
This guide is the starting point for engineers joining neblite. It summarizes how the codebase is organized, which conventions we follow, and the habits that keep contributions consistent and safe to deploy.
...
- Re-run tests before pushing. Avoid committing generated files.
