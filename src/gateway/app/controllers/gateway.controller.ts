...
import { EAuthType } from '../../../iam/domain/constants/auth-type.enum';
...
export class GatewayController {
  constructor(
    ...
    private readonly rideResponseService: RideResponseService,
  ) {}
  ...
  async getRide(@Req() request: Request, @Param('id') rideId: string) {
    ...
    return {
      ...
      data: this.rideResponseService.toRideResponse(ride, candidates),
    };
  }
  ...
  async cancelRide(
    ...
    return {
      ...
      error: null,
      data: this.rideResponseService.toRideResponse(ride),
    };
  }
  ...
  async proceedRidePayment(
    ...
    return {
      ...
      data: {
        ...this.rideResponseService.toRideResponse(ride),
        payment,
      },
    };
  }
